...
Once the data has been generated,
you also need to create a checksum of that data.
...
Because 10000 is too short,
we first use the modified dragon curve to make it longer.
...
Next, we start calculating the checksum; after one round,
we have 0111110101, which 10 characters long (even), so we continue.
