...
connected by doors. You start in the top-left room (marked S),
...
For example, suppose the passcode is hijkl. Initially,
you have taken no steps, and so your path is empty:
...
Because you start in the top-left corner, there are no "up" or "left"
...
(but that's a wall), or right. Going right means hashing hijklDR to get 5745
...
only the right door is open; after going DUR, all doors lock.
