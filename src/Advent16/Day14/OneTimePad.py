...
Considering future hashes for five-of-a-kind
sequences does not cause those hashes to be skipped; instead,
regardless of whether the current hash is a key,
...
None of the next six triples are keys,
but the one after that, at index 92, is:
